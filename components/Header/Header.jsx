            ...
            >
              ...
              <nav className="hidden lg:block">
                <ul className="flex items-center space-x-[46px]">
                  ...
                  >
                    <Link href={"/catalog"}>{language?.header?.catalog}</Link>
                  </li>
                  <li
                    className={`font-medium text-base ${
                      bg ? "text-[#333]" : "text-white"
                  ...
                  >
                    <Link href={"/service"}>{language?.header?.service}</Link>
                  </li>
                  <li
                    className={`font-medium text-base ${
                      bg ? "text-[#333]" : "text-white"
                  ...
                  >
                    <Link href={"/about"}>{language?.header?.about}</Link>
                  </li>
                  <li
                    className={`font-medium text-base ${
                      bg ? "text-[#333]" : "text-white"
                  ...
                  >
                    <Link href={"/partner"}>{language?.header?.partner}</Link>
                  </li>
                </ul>
              </nav>
                ...
                >
                  <span
                    className={`${
                      ...
                      bg ? "bg-black border-black" : "bg-white border-white"
